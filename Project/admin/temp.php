...
<div style="margin:50px;">
    <div style="width:90%; box-shadow:-1px 1px 1px 1px Gray;" class="table-responsive">
        <table class="table table-striped table-bordered" data-page-length='10'>
            <tr style="border-bottom:1px;">
                <H5 style="font-size:medium; margin:10px; margin-top:20px;">Order ID. :
                    1</H5>
            </tr>
            <tr>
                <td>
                         ...
                         <div class="row">
                           <div class="col-8 ">
                                <ul class="multi-column-dropdown" >
                                    <li >
                                        <h5 class="pt-1 ">
                                            Order Number:<span class="text-md-center"></span>
                                        </h5>
                                    </li>
                                    <li>
                                        <h5 class="pt-1">
                                            Num Of Product:<span class="text-md-center">abc</span>
                                        </h5>
                                    </li>
                                    <li>
                                        <h5 class="pt-1 ">
                                            Price :<span class="item_price text-md-center">1234</span> <span class="col-form-label-sm text-md-center">INR</span>
                                        </h5>
                                    </li>
                                    <li>
                                        <h5 class="pt-1">
                                            Payment Method :<span class="text-md-center"></span>
                                        </h5>
                                    </li>
                                    <li>
                                        <h5 class="pt-1">
                                           Status :<span class="text-md-center"> </span>
                                        </h5>
                                    </li>
                                </ul>
                                ...
                                <div class="col-4 d-flex align-items-end flex-column">
                                    <div class="p-2">
                                        <a name="" id="" class="btn btn-primary" href="#" role="button">TRACK</a>
                                    </div>
                                    <div class="p-2">
                                    <a href=""  data-toggle="modal" data-target="#myModal"> <div class="rem">
                                        <div class="close1" style="top:36px;right:23px;" > </div>
                                        </div>
                                     </div>
                                    </a>
                                </div> 
               ...
               if (readerPrdouct.HasRows)
               {
                   ...
                   <div style="margin:50px;">
                    ...
                    <table class="timetable_sub">
                        ...
                        <li class="<% Response.Write(pkgTrack1); %>">Order Processing</li><li class="<% Response.Write(pkgTrack2); %>">Pre-Production</li><!--
